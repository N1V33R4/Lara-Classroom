    ...
    $widgets['before_content'][] = [
        ...
        'content' => [ // widgets 
            [ 
                ...
                'content' => ['header' => 'Students', 'body' => App\Models\Student::count()]
            ],
            [ 
                'type' => 'card',
                'wrapper' => ['class' => 'col-sm-6 col-md-4 col-lg-3'],
                'class'   => 'bg-success text-white',
                'content' => ['header' => 'Lectuers', 'body' => App\Models\Lecturer::count()]
            ],
            [ 
                'type' => 'card',
                'wrapper' => ['class' => 'col-sm-6 col-md-4 col-lg-3'],
                'class'   => 'bg-primary text-white',
                'content' => ['header' => 'Departments', 'body' => App\Models\Department::count()]
            ],
            [ 
                'type' => 'card',
                'wrapper' => ['class' => 'col-sm-6 col-md-4 col-lg-3'],
                'class'   => 'bg-danger text-white',
                'content' => ['header' => 'Rooms', 'body' => App\Models\Room::count()]
            ]
        ]
    ];
